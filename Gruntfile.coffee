module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    sed:
      speakjs:
        path: 'public/vendor/speak.js/speakClient.js'
        pattern: 'js/resources/speak/speakWorker.js'
        replacement: 'vendor/speak.js/speakWorker.js'
  ...
  grunt.registerTask 'compile', ['coffeelint','mochaTest','coffee','uglify','stylus','cssmin','sed']
